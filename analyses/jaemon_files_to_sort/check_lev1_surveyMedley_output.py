...
path = '/oak/stanford/groups/russpold/data/uh2/aim1/BIDS/derivatives/output_surveyMedley_noderivs'
...
discrepant_dirs = dirs_array[diff_array != 0]
if discrepant_dirs.size > 0:
    print("Directories with discrepancies:")
    for dir in discrepant_dirs:
        print(dir)
else:
