#!/bin/bash
##
#SBATCH -J brain_behavior_slope_ftest_min_obs_6_min_unique_3_min_obs_binary_None
...
/oak/stanford/groups/russpold/data/uh2/aim1/derivatives/survey_medley_results/questionnaire_brain_behavior_slope_ftest/output_glm_ftest_min_obs_6_min_unique_3_min_obs_binary_None/randomise_call.sh
